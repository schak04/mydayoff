...
import { CalendarDays, CheckCircle, Clock, XCircle, Plus, DollarSign, Banknote, Receipt } from 'lucide-react';
...
const Dashboard = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            {(user?.role === 'Manager' || user?.role === 'Admin') && (teamPendingCount > 0 || teamPendingClaimsCount > 0) && (
